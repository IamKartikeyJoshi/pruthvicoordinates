        ...
        <section className="py-24 bg-secondary/20">
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {values.map((value, i) => (
                <div key={i} className="bg-popover p-8 border-l-4 border-accent hover:shadow-xl transition-all duration-500">
                  <div className="flex items-center gap-4 mb-6">
                    <span className="font-mono text-4xl text-foreground/10 font-bold">{value.number || `0${i + 1}`}</span>
                  </div>
        ...
        <section className="py-24 bg-foreground text-background">
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {team.map((member, i) => (
                <div key={i} className="border border-background/20 p-6 hover:border-accent transition-colors group">
                  ...
                  <div className="mt-4 pt-4 border-t border-background/10 font-mono text-[10px] text-background/40">{member.license}</div>
                </div>
              ))}
            </div>
          </div>
